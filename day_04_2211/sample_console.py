...
for elem in text:
    print(text2art(elem.center(18,".") ,font='block',chr_ignore=False))

name = "Adam"  # input("Podaj swoje imię: ")
name = text2art(f"name - to dla Ciebie","random")
gender = art("woman") if name.endswith("a") else art("men")

cytat = choice(cytaty)
# print(text2art("cytat", font="cards"))
print(name)
print(text2art("CYTAT", font="dohn"))
print(cytat[0])
print(text2art(cytat[1], font="white_bubble"))
print("----------------------------------------------------------------")
print(text2art("Selkcja Informatyki szkolnej", font="white_bubble"), "https://github.com/PTI/")
